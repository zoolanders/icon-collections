...
export const minifyCss = (options = {}) => vinylMap(function (buff, filename) {
    return new CleanCSS(options).minify(buff.toString()).styles;
});

export const minifyJs = (options = {}) => vinylMap(function (buff, filename) {
 ...
 */
export const tagFiles = metadata => vinylMap(function (buff, filename) {
 ...
 */
export const replaceVars = metadata => vinylMap(function (buff, filename) {
